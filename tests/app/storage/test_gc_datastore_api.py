...
from app.storage import gc_datastore_api


class TestGCDatastoreAPI(AppContextTestCase):

    def setUp(self):
        super().setUp()

        self.mock_client = mock.Mock()
        self._app.eq['gc_datastore'] = self.mock_client
    ...
    def test_get_by_key(self):
        ...
        returned_model = gc_datastore_api.get_by_key(QuestionnaireState, 'someuser')
